    ...
    return (
        ...
        <nav className="fixed top-0 left-0 w-full bg-white shadow-2xl z-50">
          <div className="max-w-6xl mx-auto px-4 py-2 flex justify-between items-center">
            ...
            <a href="tel:+919326219059" className='md:hidden inline-block px-5 py-3 rounded-[90px] bg-red-500 text-white border-2 hover:bg-white hover:text-red-500 hover:border-red-500 duration-300 ease-in-out uppercase font-bold'>Emergency</a>
